...
export default function NewLpWhyChooseUs() {
  ...
  return (
    <section className="w-full bg-[#172D5C] pt-12 text-white">
      <div className="mx-auto mb-20 max-w-7xl px-6 xl:px-0">
        ...
        <div className="flex flex-col gap-12 lg:gap-24 md:flex-row">
          {/* Advantage Column */}
          <div className="h-[432px] flex-1 border-l-4 border-pink-500 bg-[#F3F3F4]/10 p-8">
      ...
      >
        ...
        <h3 className="mx-auto lg:block hidden max-w-4xl font-impact text-2xl font-bold leading-7 tracking-normal text-white md:text-4xl lg:text-4xl">
            {t('commitmentBanner1')}
            <br />
            {t('commitmentBanner2')}
            <br />
