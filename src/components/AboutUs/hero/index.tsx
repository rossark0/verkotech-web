    ...
    <section className="w-full px-4">
      <div className="mx-auto flex w-full max-w-[1000px] flex-col pt-8">
        <div className="mb-2 flex w-auto self-start border border-verkotech-primary p-4">
          <h2 className="max-w-4xl text-3xl font-semibold uppercase  leading-tight tracking-tighter text-verkotech-primary md:max-w-7xl md:text-6xl">
            {t('title')}
          </h2>
        </div>
        <div className="mb-6 flex w-auto self-start border bg-slate-50 p-4">
          <h3 className=" max-w-4xl text-3xl font-semibold  leading-tight tracking-tighter text-slate-500 md:max-w-7xl md:text-4xl">
            {t('your')}{' '}
